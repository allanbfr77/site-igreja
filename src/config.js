  ...
  tabs: [
    {
      ...
      items: [
        { type: "pdf", num: "Aula 01", title: "Cristologia", cover: "/estudos/capas/cristologia-1.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula1.pdf` },
        { type: "pdf", num: "Aula 02", title: "Jesus Cristo, Homem — A vida humana de Jesus", cover: "/estudos/capas/cristologia-2.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula2.pdf` },
        { type: "pdf", num: "Aula 03", title: "Jesus Cristo, Homem — As limitações de Jesus", cover: "/estudos/capas/cristologia-3.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula3.pdf` },
        { type: "pdf", num: "Aula 04", title: "Jesus Cristo, Deus — A evidência dos Evangelhos", cover: "/estudos/capas/cristologia-4.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula4.pdf` },
        { type: "pdf", num: "Aula 05", title: "Evidência de Cristo nos Evangelhos", cover: "/estudos/capas/cristologia-5.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula5.pdf` },
        { type: "pdf", num: "Aula 06", title: "Jesus Cristo, Deus — Testemunhos dos apóstolos", cover: "/estudos/capas/cristologia-6.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula6.pdf` },
        { type: "pdf", num: "Aula 07", title: "Jesus Cristo: a identificação de Jeová", cover: "/estudos/capas/cristologia-7.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula7.pdf` },
        { type: "pdf", num: "Aula 08", title: "Nomes e títulos de Cristo", cover: "/estudos/capas/cristologia-8.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula8.pdf` },
        { type: "pdf", num: "Aula 09", title: "A encarnação de Cristo", cover: "/estudos/capas/cristologia-9.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula9.pdf` },
        { type: "pdf", num: "Aula 10", title: "Os três ofícios de Cristo", cover: "/estudos/capas/cristologia-10.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula10.pdf` },
        { type: "pdf", num: "Aula 11", title: "O ensino no ministério de Cristo", cover: "/estudos/capas/cristologia-11.png", pdf: `${PDF_BASE}/CRISTOLOGIA_Aula11.pdf` },
      ],
    },
    {
      id: "apocalipse",
      ...
      items: [
        { type: "video", num: "Aula 01", title: "Escatologia — Parte 1", videoId: "W-9M-PvIs3I", cover: "/estudos/capas/apocalipse-1.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula1.pdf` },
        { type: "video", num: "Aula 02", title: "Escatologia — Parte 2", videoId: "UjytdzVytzI", cover: "/estudos/capas/apocalipse-2.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula2.pdf` },
        { type: "video", num: "Aula 03", title: "Escatologia — Parte 3", videoId: "NZ1r3sO4dfU", cover: "/estudos/capas/apocalipse-3.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula3.pdf` },
        { type: "video", num: "Aula 04", title: "Escatologia — Parte 4", videoId: "V_scgNPGmUM", cover: "/estudos/capas/apocalipse-4.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula4.pdf` },
        { type: "video", num: "Aula 05", title: "Escatologia — Parte 5", videoId: "Q1J2GK_81L0", cover: "/estudos/capas/apocalipse-5.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula5.pdf` },
        { type: "video", num: "Aula 06", title: "Capítulo 1", videoId: "foY5i2GJQHI", cover: "/estudos/capas/apocalipse-6.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula6.pdf` },
        { type: "video", num: "Aula 07", title: "Capítulos 2 e 3", videoId: "Ns_fhLRZfBc", cover: "/estudos/capas/apocalipse-7.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula7.pdf` },
        { type: "video", num: "Aula 08", title: "Capítulo 4", videoId: "S2v4D7edAZY", cover: "/estudos/capas/apocalipse-8.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula8.pdf` },
        { type: "video", num: "Aula 09", title: "Capítulos 5 e 6", videoId: "4BEZ3cBxAxs", cover: "/estudos/capas/apocalipse-9.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula9.pdf` },
        { type: "video", num: "Aula 10", title: "Capítulos 7 e 8", videoId: "yyNB9latoJA", cover: "/estudos/capas/apocalipse-10.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula10.pdf` },
        { type: "video", num: "Aula 11", title: "Capítulo 9", videoId: "B8nssUilmUw", cover: "/estudos/capas/apocalipse-11.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula11.pdf` },
        { type: "video", num: "Aula 12", title: "Capítulo 10", videoId: "1vcK5Iq01Xg", cover: "/estudos/capas/apocalipse-12.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula12.pdf` },
        { type: "video", num: "Aula 13", title: "Capítulo 11", videoId: "6ytzOZ6hxPo", cover: "/estudos/capas/apocalipse-13.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula13.pdf` },
        { type: "video", num: "Aula 14", title: "Capítulo 12", videoId: "8xSw2fvRmos", cover: "/estudos/capas/apocalipse-14.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula14.pdf` },
        { type: "video", num: "Aula 15", title: "Capítulo 13", videoId: "e2Hx7JHyCws", cover: "/estudos/capas/apocalipse-15.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula15.pdf` },
        { type: "video", num: "Aula 16", title: "Capítulo 14", videoId: "9nF4GHUhqc8", cover: "/estudos/capas/apocalipse-16.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula16.pdf` },
        { type: "video", num: "Aula 17", title: "Capítulos 15 e 16", videoId: "KKLdA2VGj6k", cover: "/estudos/capas/apocalipse-17.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula17.pdf` },
        { type: "video", num: "Aula 18", title: "Capítulos 17 e 18 (parte 1)", videoId: "Ix74fta9zYE", cover: "/estudos/capas/apocalipse-18.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula18.pdf` },
        { type: "video", num: "Aula 19", title: "Capítulos 18 (parte 2) e 19", videoId: "nTVSwWWeDws", cover: "/estudos/capas/apocalipse-19.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula19.pdf` },
        { type: "pdf", num: "Aula 20", title: "Capítulo 20", cover: "/estudos/capas/apocalipse-20.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula20.pdf` },
        { type: "video", num: "Aula 21", title: "Capítulos 21 e 22", videoId: "Ezp3lBmE7gM", cover: "/estudos/capas/apocalipse-21.png", pdf: `${PDF_BASE}/APOCALIPSE_Aula21.pdf` },
      ],
    },
    {
      id: "espirito",
      ...
      items: [
        { type: "pdf", num: "Aula 01", title: "Quem é o Espírito Santo?", cover: "/estudos/capas/espirito-1.png", pdf: `${PDF_BASE}/ESPIRITO_Aula1.pdf` },
        { type: "pdf", num: "Aula 02", title: "Os símbolos do Espírito Santo", cover: "/estudos/capas/espirito-2.png", pdf: `${PDF_BASE}/ESPIRITO_Aula2.pdf` },
        { type: "pdf", num: "Aula 03", title: "O Espírito Santo e as Escrituras", cover: "/estudos/capas/espirito-3.png", pdf: `${PDF_BASE}/ESPIRITO_Aula3.pdf` },
        { type: "pdf", num: "Aula 04", title: "Da criação até o nascimento de Jesus", cover: "/estudos/capas/espirito-4.png", pdf: `${PDF_BASE}/ESPIRITO_Aula4.pdf` },
        { type: "pdf", num: "Aula 05", title: "Do nascimento de Jesus até Pentecostes", cover: "/estudos/capas/espirito-5.png", pdf: `${PDF_BASE}/ESPIRITO_Aula5.pdf` },
        { type: "pdf", num: "Aula 06", title: "Depois de Pentecostes", cover: "/estudos/capas/espirito-6.png", pdf: `${PDF_BASE}/ESPIRITO_Aula6.pdf` },
        { type: "pdf", num: "Aula 07", title: "O Espírito Santo na vida do crente", cover: "/estudos/capas/espirito-7.png", pdf: `${PDF_BASE}/ESPIRITO_Aula7.pdf` },
        { type: "pdf", num: "Aula 08", title: "A luta interior do crente", cover: "/estudos/capas/espirito-8.png", pdf: `${PDF_BASE}/ESPIRITO_Aula8.pdf` },
        { type: "pdf", num: "Aula 09", title: "O batismo com o Espírito Santo", cover: "/estudos/capas/espirito-9.png", pdf: `${PDF_BASE}/ESPIRITO_Aula9.pdf` },
        { type: "pdf", num: "Aula 10", title: "Pecados contra o Espírito Santo", cover: "/estudos/capas/espirito-10.png", pdf: `${PDF_BASE}/ESPIRITO_Aula10.pdf` },
        { type: "pdf", num: "Aula 11", title: "O fruto do Espírito", cover: "/estudos/capas/espirito-11.png", pdf: `${PDF_BASE}/ESPIRITO_Aula11.pdf` },
        { type: "pdf", num: "Aula 12", title: "Princípios e objetivos dos dons", cover: "/estudos/capas/espirito-12.png", pdf: `${PDF_BASE}/ESPIRITO_Aula12.pdf` },
        { type: "pdf", num: "Aula 13", title: "Os dons de ministério", cover: "/estudos/capas/espirito-13.png", pdf: `${PDF_BASE}/ESPIRITO_Aula13.pdf` },
        { type: "pdf", num: "Aula 14", title: "Os dons de serviço", cover: "/estudos/capas/espirito-14.png", pdf: `${PDF_BASE}/ESPIRITO_Aula14.pdf` },
        { type: "pdf", num: "Aula 15", title: "Os dons de sinais", cover: "/estudos/capas/espirito-15.png", pdf: `${PDF_BASE}/ESPIRITO_Aula15.pdf` },
        { type: "pdf", num: "Aula 16", title: "Como reconhecer o seu dom", cover: "/estudos/capas/espirito-16.png", pdf: `${PDF_BASE}/ESPIRITO_Aula16.pdf` },
        { type: "pdf", num: "Aula 17", title: "Como ficar cheio do Espírito Santo", cover: "/estudos/capas/espirito-17.png", pdf: `${PDF_BASE}/ESPIRITO_Aula17.pdf` },
      ],
    },
    {
      id: "capacitacao",
      label: "Capacitação",
      items: [
        { type: "pdf", num: "Curso", title: "Capelania", cover: "/estudos/capas/capelania.png", pdf: `${PDF_BASE}/CAPELANIA.pdf` },
        { type: "pdf", num: "Curso", title: "Evangelismo", cover: "/estudos/capas/evangelismo.png", pdf: `${PDF_BASE}/EVANGELISMO.pdf` },
      ],
    },
  ],
};
...
export const MINISTRIES = [
  {
    ...
    image: "/min/comunicacoes.png", // foto do ministério, ex: "/min/louvor.jpg" (vazio = fundo dourado)
